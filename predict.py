...
model_path = r'E:\log_cloud\model.pth'
...
for file in file_all:
    ...
    landsat = landsat_modis_img[0:12,:,:]
    modis = landsat_modis_img[12:33,:,:]



    modis = np.reshape(modis, (1, 21, 256, 256))
    landsat = np.reshape(landsat, (1, 12, 256, 256))
